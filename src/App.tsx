...
function App() {
  ...
  const addTask = (nameOverride?: string, metricOverride?: MetricType) => {
    const nameToUse = nameOverride || inputName;
    const metricToUse = metricOverride || inputMetric;
  ...
  const handleEnterApp = () => {
    ...
    setTimeout(() => {
      setShowSplash(false);
    }, 1500); // Match animation duration roughly
  };
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-stone-300 font-sans flex flex-col relative overflow-x-hidden">
      {/* Dungeon Texture Overlay */}
      <div className="absolute inset-0 opacity-5 pointer-events-none bg-[url('https://www.transparenttextures.com/patterns/black-scales.png')] z-0"></div>
      {/* Vignette */}
